...
public class ReceivedDataAdapter {
    ...
    final private static String ADDRESS = "00:06:66:80:C5:42";

    boolean connectButton = true;

    private Logger controllerLogger, sensor500Logger, voltageLogger;

    private double elevator, rudder, airspeed, cadence, ultsonic, atmpress, ultsonicvolt,cadencevolt, servovolt;
    private int time,  Selector, trim;
    ...
    public ReceivedDataAdapter(Context context){
       ...
       sensor500Logger  = new Logger("Sensor500ms","androidTime,mbedTime,airspeed,cadence,ultrasonic,atmpressure");
       voltageLogger = new Logger("Voltage", "androidTime,mbedTime,ultsonicvoltage,cadencevoltage,servovoltage");
    ...
    public double getUltsonicVoltage(){;
        return ultsonicvolt;
    }
    public double getCadenceVoltage(){;
        return cadencevolt;
    }
